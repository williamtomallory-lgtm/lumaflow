...
- **新モデル追加**：`claude-fable-5-1`、`qwen3.8-flash`、`glm-5.3-flash`、および視覚モデル `deepseek-v4-flash-vision-exp` に対応しました（Thanks @a1094174619 #3094）。
...
**リリース日**：2026.09.09 | [Full Changelog](https://github.com/zhayujie/CowAgent/compare/2.1.7...2.1.8)
