...
| --- | --- | --- |
| [2.1.8](/releases/v2.1.8) | 2026.09.09 | Multi-Agent teams (team management, group collaboration, multiple channel instances), manual scheduled tasks, context-usage visualization, model fallback and new search providers, workspace file editing |
