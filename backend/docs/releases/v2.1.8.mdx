...
CowAgent is now a multi-Agent framework. You can create multiple Agents to form a team, each with its own responsibilities, model, skills, and knowledge, and have them collaborate on complex tasks within a single session. Supported on the Web console, the desktop client, and channel integrations:
...
- **New models**: added `claude-fable-5-1`, `qwen3.8-flash`, `glm-5.3-flash`, and the vision model `deepseek-v4-flash-vision-exp` (Thanks @a1094174619 #3094).
...
- **Image generation**: fixed ModelScope `IMAGE_CREATE` failing due to a parameter mismatch (Thanks @Anai-Guo #3097).
...
**Release date**: 2026.09.09 | [Full Changelog](https://github.com/zhayujie/CowAgent/compare/2.1.7...2.1.8)
