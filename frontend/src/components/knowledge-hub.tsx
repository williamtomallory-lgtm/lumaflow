...
export function KnowledgeHub({ products = [], assets = [], dataSource = "local", initialQuery = "", section: controlledSection, onSectionChange, kitProductId, onOpenProduct, onToast }: KnowledgeHubProps) {
